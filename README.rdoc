...
This is an update to attachment_fu for old apps that used it before activestorage.

It was first a plugin by Rick Olson (http://techno-weenie.net) and is the successor
to acts_as_attachment. To get a basic run-through of its capabilities, check out {Mike Clark's
