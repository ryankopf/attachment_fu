...
{<img src="https://badge.fury.io/rb/ryankopf-attachment_fu.svg" alt="Gem Version" />}[https://rubygems.org/gems/ryankopf-attachment_fu]
{<img src="http://ruby-gem-downloads-badge.herokuapp.com/ryankopf-attachment_fu?type=total&color=brightgreen" />}[https://rubygems.org/gems/pothoven-attachment_fu]
{<img src="http://ruby-gem-downloads-badge.herokuapp.com/ryankopf-attachment_fu?color=brightgreen&label=for-this-version" />}[https://rubygems.org/gems/pothoven-attachment_fu]
...
[:jpeg_quality]
    ...
    * You can also use a Hash, with keys being either  thumbnail symbols (I
    ...
    Rmagick/MiniMagick: 75%). Note that only
...
[:processor]
    ...
    include ImageScience, Rmagick, MiniMagick. Default is
