    ...
    module S3Backend
      ...
      module ClassMethods
        ...
        def custom_base_domain
          AttachmentFu::Backends::S3Backend.custom_base
        end

        def custom_fullpath_domain
          AttachmentFu::Backends::S3Backend.custom_fullpath
        end
      end
      ...
      def download_to_temp_file
        ...
        tempfile = Tempfile.new(random_tempfile_filename, ::AttachmentFu.tempfile_path)
      ...
      protected
        ...
        def rename_file
          ...
          old_obj = bucket.object(old_full_filename)
          obj = bucket.object(full_filename)
